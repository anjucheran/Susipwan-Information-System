...
<?php
include("php/header_owner.php");
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                  <div class="col-md-12">
                      <h1 class="page-head-line">Teacher Registration
                      </div>
                </div>
                <!-- /. ROW  -->
                <div class="row">
                  ...
                  $linki =mysqli_connect("localhost","root","","Member")
                  or die('error connecting to mysql server');
                  ...
                  $sql="INSERT INTO users (name,nic,address,contact,username,dob,usertype) VALUES ('".$name."','".$nic."','".$address."','".$contact."','".$email."','".$dob."','Teacher')";
                  $sqli="INSERT INTO members (member_id, member_name, member_password, member_email) VALUES (2,'".$name."','e3ceb5881a0a1fdaad01296d7554868d', '".$email."')";
                ...
                <body>
                    ...
                    <section class="registration_form">
                      <div class="contain">
                          ...
                          <form action="add_teacher.php" method="post" name="form" onsubmit="return validateForm()">
                              <p>
