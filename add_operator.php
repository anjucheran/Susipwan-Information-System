...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                  <div class="col-md-12">
                      <h1 class="page-head-line">Operator Registration
                      </div>
                </div>
                <!-- /. ROW  -->
                <div class="row">
                  ...
                  $sqli="INSERT INTO members (member_id, member_name, member_password, member_email) VALUES (1,'".$name."','96e79218965eb72c92a549dd5a330112', '".$email."')";
